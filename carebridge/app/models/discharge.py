import uuid
from sqlalchemy import Text, ARRAY, JSON, DateTime, Integer
...
class DischargeEvent(Base):
    ...
    call_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=True)
    ...
    call_attempt_count: Mapped[int] = mapped_column(Integer, default=0)